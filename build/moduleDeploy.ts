...
export const moduleDeploy = (): void => {
  ...
  const connection: any = {
    ...
    port: process.env.MAGENTO_SSH_PORT,
  ...
  if (process.env.MAGENTO_SSH_PASSWORD || env.MAGENTO_SSH_PASSWORD) {
    ...
    connection.privateKey = fs.readFileSync(process.env.MAGENTO_SSH_PRIVATE_KEY || env.MAGENTO_SSH_PRIVATE_KEY, 'utf8');
  }
